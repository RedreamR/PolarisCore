...
public class InitGame extends Menu {
        ...
        if (this.takeABreak > 0) {
            ...
            try {
                if (iStepID == 0) {
                    ...
                    CFG.FONT_BOLD = FontFix.loadFont(Game.lang.get("font"), Game.lang.get("charset"), Game.settingsManager.FONT_MAIN_SIZE);
                } else if (iStepID == 2) {
                    this.loadImagesInit();
                    ...
                    CFG.FONT_REGULAR = FontFix.loadFont(Game.lang.get("font2"), Game.lang.get("charset"), Game.settingsManager.FONT_MAIN_SIZE);
                    this.takeABreak = 2;
                } else if (iStepID == 6) {
                    ...
                    Renderer.loadFontBorder(Game.lang.get("fontCivNames"), Game.lang.get("charset"));
                    this.takeABreak = 2;
                    this.setLoadText("Loading Fonts");
                } else if (iStepID == 13) {
                    ...
                    FinalityLogger.debug("STEP SCENARIO "+(System.currentTimeMillis() - lTime));
                    this.setLoadText("Loading");
                } else if (iStepID == 148) {
    ...
    private final void loadImages_3() {
        ...
        int i;
        for(i = 0; i < GameValues.inGame.ARMY_LEFT_IMAGES + 1; ++i) {
        ...
        for(i = 0; i < GameValues.capital.CAPITAL_IMAGES; ++i) {
    ...
    private final void loadImages_7() {
        ...
        try {
            tempFileT = FileManager.loadFile("ui/" + CFG.getRescouresPath() + "boxes/" + "boxTitleBorder.txt");
        ...
        try {
            tempFileT = FileManager.loadFile("ui/" + CFG.getRescouresPath() + "buttons/" + "buttonPlayPadding.txt");
        ...
        try {
            tempFileT = FileManager.loadFile("ui/" + CFG.getRescouresPath() + "message/" + "messageMaskY.txt");
        ...
        try {
            tempFileT = FileManager.loadFile("ui/" + CFG.getRescouresPath() + "message/" + "warMaskY.txt");
